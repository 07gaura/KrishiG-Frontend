...
function Cartdetails({item,index,SetCartProduct,get_cart_count_value}) {
  ...
  return (
    <div className='col-11 d-flex m-2 cart-block'>
        ...
        <div className='col-12 d-flex'>
            ...
            <div className='col-4 d-flex btn-warning rounded'>
            <div className=''>
              <i class="fa-solid fa-minus m-1" onClick={decreaseQuantity}></i>
            </div>
            <input type="number" value={quantity} onChange={changeQuantity} className='border-warning resizedTextbox'/>
            <div className='btn-warning'>
              <i class="fa-solid fa-plus m-1" onClick={increaseQuantity}></i>
            </div>
        ...
        <i class="fa-solid fa-trash" onClick={remove_from_cart}></i>
        </div>
    </div>
  )
}
